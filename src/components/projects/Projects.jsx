  ...
  return (
    <div id='Projects' className='p-10 md:p-24 text-white'>
        ...
        <div className='py-12 px-8 flex flex-wrap gap-5'>
            ...
            <ProjectCard title="Wellness Hub" main="A doctor appointment booking web app built with the MERN stack. Users can find doctors by specialty and schedule appointments through a secure interface." ImgSrc={DA} CodeLink='https://github.com/Amlan029/wellnesshub-frontend' DemoLink='https://wellnesshub-frontend-five.vercel.app/'/>
        </div>
    </div>
  )
}
